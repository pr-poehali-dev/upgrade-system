  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Накипь в чайнике:
          <span className="block text-sage">как её победить?</span>
        </h1>
        ...
        >
          Каждый раз, когда вы кипятите воду, в чайнике оседают соли кальция и магния. Этот проект объясняет химию накипи и рассказывает о простых способах защиты.
        </p>
